      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg mb-4">
            Explore meus projetos e veja o que posso criar para você
          </p>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-400 to-blue-500 text-slate-900 font-bold rounded-lg hover:shadow-lg hover:shadow-cyan-400/50 transition-all duration-300"
                  >
